    ...
    <div className="relative bg-neutrals-neutral-white w-full h-[4948px] overflow-hidden text-left text-base text-secondarycolor-secondarycolor font-p1">
      ...
      <div className="absolute top-[883px] left-[0px] flex flex-col items-center justify-start gap-[100px] text-3xl text-neutrals-neutral-black font-h1">
        <div className="flex flex-col items-center justify-start relative gap-[20px]">
          <div className="absolute my-0 mx-[!important] top-[0px] left-[0px] rounded-lg bg-darkorange-100 w-[361px] h-[350px] z-[0]" />
          <img className="relative rounded-lg w-[361px] h-[350px] object-cover z-[1]" alt="" src="/image-3@2x.png" />
          <div className="flex flex-col items-center justify-start gap-[7px] z-[2]">
            <div className="flex flex-row items-center justify-center">
              <b className="relative leading-[28px]">Seamless sharing</b>
            </div>
        ...
        <div className="flex flex-col items-center justify-start relative gap-[20px]">
          <div className="absolute my-0 mx-[!important] top-[0px] left-[0px] rounded-lg bg-darkorange-200 w-[361px] h-[350px] z-[0]" />
          <img className="relative rounded-lg w-[361px] h-[350px] object-cover z-[1]" alt="" src="/image-4@2x.png" />
          <div className="flex flex-col items-center justify-start gap-[7px] z-[2]">
            <div className="flex flex-row items-center justify-center">
              <b className="relative leading-[28px]">Cook together, miles apart</b>
            </div>
            <div className="flex flex-col pt-[5px] px-0 pb-0 items-center justify-center text-center text-base font-p1">
              <div className="relative leading-[20px] inline-block w-[327px]">{`Step into the virtual kitchen and join your favourite creators as they prepare their meals. With realtime video sharing, follow along fellow foodies guiding you through each step. Or start a cookalong yourself and share your tips and tricks with the community! `}</div>
            </div>
          </div>
        </div>
        ...
        <div className="relative bg-darkseagreen w-[390px] h-[665px] overflow-x-auto shrink-0 text-base font-p1">
          <div className="absolute top-[161px] left-[15px] w-[1799px] h-[460px]">
            <div className="absolute top-[calc(50%_-_230px)] left-[calc(50%_-_899.5px)] w-[1799px] overflow-hidden flex flex-row items-start justify-start gap-[40px]">
              <div className="flex flex-col items-start justify-start relative gap-[10px]">
                <div className="flex flex-col items-start justify-start z-[0]"></div>

                <ImageCarousel />
              </div>
            </div>
          </div>
          <div className="h-[546px] flex flex-col items-center justify-start gap-[20px]">
            <img
              className="relative rounded-xl w-[327px] h-[234px] object-cover"
              alt=""
              src="/looptroop-a-happy-robot-looking-at-the-screen-of-a-computer-wit-c744e00e0d7b4f0797989bd4dc4300c6-1@2x.png"
            />
              ...
              <div className="flex flex-col items-center justify-start gap-[7px]">
                ...
                <div className="flex flex-col pt-[5px] px-0 pb-0 items-center justify-center text-center text-base font-p1">
                  <div className="relative leading-[20px] inline-block w-[327px]">
                    ...
                    contributions to promptly detect potential violations, ensuring users can browse and share recipes
                    without encountering offensive content. We also value community input through our ticket system,
                    allowing users to report objectionable content and contribute to further AI training, fostering a
          ...
          <div className="flex flex-col items-center justify-start gap-[20px] text-center text-13xl text-secondarycolor-secondarycolor">
